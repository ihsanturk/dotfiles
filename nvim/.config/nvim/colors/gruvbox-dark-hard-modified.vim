...
if has("nvim")
  ...
  let g:terminal_color_6 =  "#8ec07c" "light green
  let g:terminal_color_7 =  "#d5c4a1" "cream
  let g:terminal_color_8 =  "#665c54" "dark cream, brown
  ...
  let g:terminal_color_15 = "#fbf1c7" "white-ish, cream
...
hi clear
syntax reset
let g:colors_name = "gruvbox-dark-hard-modified"
...
call <sid>hi("Cursor",        s:gui00, s:gui08, s:cterm00, s:cterm05, "", "")
...
highlight CurrentSearch
	 \ cterm=bold ctermfg=10 ctermbg=3
	 \ gui=bold guifg=#222222 guibg=#fe8019
" highlight link SearchCursor WarningMsg
highlight Search cterm=reverse,bold ctermfg=108 ctermbg=235
