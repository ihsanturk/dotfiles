...
## Type: QtColor
c.colors.tabs.selected.even.bg = '#99bb88'
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = '#99bb88'
...
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'yt': 'https://www.youtube.com/results?search_query={}'}
...
config.bind(',n', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/css/solarized_dark.css ""')
